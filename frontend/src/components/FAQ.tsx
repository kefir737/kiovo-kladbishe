...
const defaultFaqItems = [
  ...
  },
  {
    ...
    answer: 'Транспорт на территорию не допускается, так как есть только дорожки для пешеходов. Но есть возможность припарковаться на бесплатной парковке у главного входа.',
  },
  {

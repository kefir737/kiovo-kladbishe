...
const defaultFaqItems = [
  ...
  },
  {
    ...
    answer: 'Внутренние проезды предназначены только для спецтранспорта и маломобильных граждан по предварительной заявке. Остальные посетители проходят пешком от парковки.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Сообщите в пункт охраны или по телефону диспетчера. Заявки на спил сухостоя и ремонт ограждений фиксируются и выполняются в порядке очереди.',
  },
];
